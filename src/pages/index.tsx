import { Company, Enderecos } from ".prisma/client"
...
export default function Home({ users }: any) {
    ...
    return (
        <div className={styles.boxUserBody} >
            {users.map((user: any) => (
                <div className={styles.boxUser} key={user.uuid}>
                    ...
                    <section className={styles.flexRow}>
                        ...
                        <div className={styles.contain}>
                            <p>{user.name}</p>
                            <p>{
                                user.enderecos.map((enderecos: Enderecos) => (
                                    <div key={enderecos.uuid}>
                                        <p>
                                            - {enderecos.rua}, {enderecos.numero} <br />
                                            <span className={styles.small}>{enderecos.cep}, {enderecos.complemento}</span>
                                        </p>
                            ...
                            <p>{
                                user.company.map((company: any) => (
                                    <div key={company.uuid}>
                                        <p>
                                            Empresas: {company.nomeFantasia}, <br />
                                            <span className={styles.small}>
                                                {
                                                    company.geolocation.map((geolocation: any) => (
